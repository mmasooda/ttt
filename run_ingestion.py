#!/usr/bin/env python3
"""
TTT-Enhanced BYOKG-RAG Ingestion Pipeline
Ingests all files from S3 bucket and builds knowledge graph
"""
...
class IngestionPipeline:
    ...
    async def run_full_pipeline(self) -> Dict[str, Any]:
        ...
        try:
            logger.info("Starting full ingestion pipeline", bucket=settings.s3_bucket_name)
...
async def main():
    ...
    print("=== TTT-Enhanced BYOKG-RAG Ingestion Pipeline ===")
    ...
    try:
        ...
        response = input("\nProceed with full ingestion? (y/N): ")
        if response.lower() != 'y':
